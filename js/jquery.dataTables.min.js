...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"处理中...",sLengthMenu:"显示 _MENU_ 条",sZeroRecords:"没有找到匹配的记录",sEmptyTable:"表中没有可用数据",
sLoadingRecords:"加载中...",sInfo:"显示 _START_ 到 _END_ 共 _TOTAL_ 条",sInfoEmpty:"显示 0 到 0 共 0 条",sInfoFiltered:"(过滤 _MAX_ 条)",sInfoPostFix:"",sInfoThousands:",",sSearch:"搜索:",sUrl:"",oPaginate:{sFirst:"首页",sPrevious:"上一页",sNext:"下一页",sLast:"末页"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
